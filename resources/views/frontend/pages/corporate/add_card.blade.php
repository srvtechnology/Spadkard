@extends('layouts.app')
@section('title')
<title>User | Add Corporate Card</title>
<style type="text/css">
	.error{
		color: red;
	}
			...
			<div class="page-content container container-plus">
				<div class="card acard mt-2 mt-lg-3">
					<div class="card-header">
						...
						<a href="{{route('corp.card.list',$user_to_temp->id)}}" class="btn btn-info btn-bold px-4" >Back</a>
					</div>
					@include('frontend.include.message')
					<div class="card-box brc-blue-m2">
						<div class="card-box-body">
							<form action="{{route('insert.corporate.card')}}" method="post" enctype="multipart/form-data" id="frm">
								@csrf
								<input type="hidden" name="user_to_temp_id" value="{{$user_to_temp->id}}">
								<input type="hidden" name="template_id" value="{{$user_to_temp->template_id}}">
								<input type="hidden" name="html_id" value="{{$user_to_temp->html_id}}">
								...
								<div class="row">
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter Name" name="name" class="form-control" id="" />
										</div>
									</div>
									{{--    <div class="col-lg-4">
										<div class="form-group">
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter Email" name="email" class="form-control" id="" />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter Mobile Number" name="ph" class="form-control" id="" />
										</div>
									</div>
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter Address" name="address" class="form-control" id="" />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter Comapny Name" name="company" class="form-control" id="" value="{{$user_to_temp->company}}" />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter TagLine" name="tag" class="form-control" id="" value="{{$user_to_temp->tag}}" />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											...
											<select name="profile_id">
												<option value="">Chose Profile</option>
												@foreach($profiles as $val)
												<option value="{{$val->id}}">{{$val->profile_name}}</option>
												@endforeach
											</select>
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											<label for="">
												No of card for this profile
											</label>
											<input type="number" placeholder="Enter No of card" name="no_of_cards" class="form-control" id="" value="1"  />
										</div>
									</div>
									...
									<div class="col-lg-4" style="margin-top: 20px">
										<div class="form-group">
											...
											<img src="{{url('/')}}/public/logo/{{$user_to_temp->logo}}" style="width: 100px;height: 100px;">
										</div>
									</div>
