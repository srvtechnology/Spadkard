				...
				<div class="card acard mt-2 mt-lg-3">
					...
					<div class="card-box brc-blue-m2">
						<div class="card-box-body">
							<form action="{{route('insert.user.card')}}" method="post" enctype="multipart/form-data" id="frm">
								@csrf
								<input type="hidden" name="user_to_temp_id" value="{{$user_to_temp_id->id}}">
								<input type="hidden" name="temp_id" value="{{$user_to_temp_id->template_id}}">
								<input type="hidden" name="design_id" value="{{$user_to_temp_id->html_id}}">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter Comapny Name" name="company" class="form-control" id="" />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter TagLine" name="tag" class="form-control" id="" />
										</div>
									</div>
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<img src="{{url('/')}}/public/logo/{{$user_to_temp_id->logo}}" style="width: 100px;height: 100px;">
										</div>
									</div>
