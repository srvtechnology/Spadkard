			...
			<div class="page-content container container-plus">
				<div class="card acard mt-2 mt-lg-3">
					<div class="card-header">
						...
						<a href="{{route('details.view',@$datas->user_to_temp_id)}}" class="btn btn-info btn-bold px-4" >Back</a>

					</div>
					@include('frontend.include.message')
					<div class="card-box brc-blue-m2">
						<div class="card-box-body">
							<form action="{{route('update.user.card')}}" method="post" enctype="multipart/form-data" id="frm">
								@csrf
