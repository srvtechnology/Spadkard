...
@section('title')
<title>Admin | Add Indistry Logo</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Indistry Logo Add </h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('admin.dashboard.home')}}">SPADE KARD</a></li>
						<li class="active"> Indistry Logo Add </li>
					</ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('admin.insert.logo')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
