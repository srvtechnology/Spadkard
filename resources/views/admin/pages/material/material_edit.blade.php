					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('admin.update.mat')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									<input type="hidden" name="id" value="{{@$material->id}}">
									<div class="form-group rm50">
										<label for="title">Materail name</label>
										<input type="text"  class="form-control"  placeholder="Enter name"  name="name" value="{{@$material->name}}" >
									</div>
									<div class="clearfix"></div>
								<div class="form-group rm50">
										<label for="title">Materail Price</label>
										<input type="number"  class="form-control"  placeholder="Enter price"  name="price"  value="{{@$material->price}}" >
									</div>
