...
@section('title')
<title>Admin | Corporate Print Completed List</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Corporate Print Completed List</h4>
					<ol class="breadcrumb pull-right">
                                <li><a href="{{route('admin.dashboard.home')}}">SPADE KARD</a></li>
                                <li class="active"> Corporate Print Completed List</li>
                     </ol>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					<div class="add-btn "><a href="{{route('admin.corp.print.list')}}"><i class="icofont-minus-circle"></i> Back</a></div>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="table-responsive">
										<table class="table">
											...
											<tbody>
												@foreach($print_comp as $key=> $value)
												<tr>
													<td>{{@$key+ @$print_comp->firstItem() }}</td>
													<td>{{@$value->id}}</td>
													<td>{{@$value->name}}</td>
													<td>{{@$value->email}}</td>									
     												<td>{{@$value->ph}}</td>
													...
													<td class="rm07">
														...
														<ul>
															...
															<li><a href="{{route('admin.corp.view.print.details',$value->id)}}">View Details</a></li>
															<li><a href="{{route('admin.corp.card.link',["id"=>$value->id,"name"=>$value->name])}}">Card Link</a></li>
