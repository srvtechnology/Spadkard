...
@section('title')
<title>Admin | Corporate Print Pending List</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Corporate Print Pending List</h4>
					<ol class="breadcrumb pull-right">
                                <li><a href="{{route('admin.dashboard.home')}}">SPADE KARD</a></li>
                                <li class="active">Corporate Print Pending List</li>
                     </ol>
				</div>
			</div>
			<div class="row">
												...
												<tr>
													...
													<td class="rm07">
														...
														<ul>
															...
															<li><a href="{{route('admin.corp.print.card',$value->id)}}">Print</a></li>
