				...
				<div class="col-lg-12">
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<button type="button" class="btn btn-info btn-lg" style="float: right; margin: 10px 10px 10px 10px" data-toggle="modal" data-target="#myModal">Important Notes</button>
								...
								<form role="form" action="{{route('admin.insert.html')}}" id="frm" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="clearfix"></div>
									  <div class="form-group">
                                        <label for="title">Select Template {{-- <span style="color: red;">*</span> --}}</label>
                                      
                                        <select class="form-control rm06"style="color: black"  name="temp_id">
                                            <option value="">Select Template</option>
                                            @foreach($unq_temp as $val)
									...
									<div class="form-group rm03">
										...
										<textarea id="mytextarea1" style="width: 95%;height: 300px" name="html" {{-- onkeyup="abcd()" --}} ></textarea>
									</div>
									...
									<div class="form-group rm03">
										...
										<textarea id="mytextarea2" style="width: 95%;height: 300px" name="html_back" {{-- onkeyup="abcd()" --}} ></textarea>
									</div>
