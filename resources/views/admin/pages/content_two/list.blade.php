...
@section('title')
<title>Admin | Manage Advantage Of Digital Card</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Advantage Of Digital Card Management</h4>
					<ol class="breadcrumb pull-right">
                                <li><a href="{{route('admin.dashboard.home')}}">SPADE KARD</a></li>
                                <li class="active">Advantage Of Digital Card Management</li>
                     </ol>
				</div>
			</div>
			<div class="row">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="table-responsive">
										<table class="table">
											...
											<tbody>
												@foreach($content_two as $key=> $value)
												<tr>
													<td>{{@$key+ @$content_two->firstItem() }}</td>
													<td>{{@$value->title}}</td>
													<td>@if(@$value->image!="")<img src="{{url('/')}}/public/content_two_image_small//{{@$value->image}}" class="widthimg80"> @else No Image @endif</td>
													...
													<td class="rm07">
														...
														<ul>
															...
															<li><a href="{{route('admin.content.two.view',$value->id)}}">View</a></li>
															
															<li><a href="{{route('admin.content.two.edit',$value->id)}}">Edit</a></li>
