...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Template Edit </h4>
				...
				<div class="col-lg-12">
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="row">
								<form role="form" action="{{route('admin.update.temp')}}" id="frm" method="post" enctype="multipart/form-data">
									<div class="panel-body  rm04 col-md-6">
										...
										<div class="form-group rm50" style="margin-left: 30px !important ">
											...
											<input type="text"  class="form-control" id="AboutMe" placeholder="Enter template name" value="{{@$template->name}}"  name="name" style="width: 230px" >

										</div>
										<div class="clearfix"></div>
										<div class="form-group rm50" style="margin-left: 30px !important ">
											<label for="title">Template price</label>
											<input type="number"  class="form-control"  placeholder="Enter price"  name="price" style="width: 220px" value="{{@$template->price}}">
										</div>
										<div class="clearfix"></div>
                                  ...
                                  <div class="uplodimgfilimg ">
                                    ...
                                    <div class="form-group" style="margin-left: 30px;">
                                        ...
                                        <div class="uplodimgfilimgs">
                                            <em><img src="{{url('/')}}/storage/app/public/template_front/{{@$template->image}}" alt="" style="width: 150px !important; height: 150px !important"></em>
                                        </div>
                                    </div>
                    ...
                    <div class="uplodimgfilimg_2">
                        <em><img src="" alt="" id="img2"></em>
										  ...
										  <div class="clearfix"></div>
                                    <div class="form-group" style="margin-left: 30px;">
                                        <label for="Email">Previous Back Image</label>
                                        <div class="uplodimgfilimgs">
                                            <em><img src="{{url('/')}}/storage/app/public/template_back/{{@$template->back_image}}" alt="" style="width: 150px !important; height: 150px !important"></em>
                                        </div>
                                    </div>
									...
									<div class="panel-body rm02 rm04 col-md-6">
										<div class="form-group rm50" id="AboutMe">
											...
											<input type="text"  class="form-control"  placeholder="Enter Dummy name"  name="dummy_name" value="{{@$template->dummy_name}}">
										</div>
										<div class="form-group rm50" id="AboutMe">
											<label for="title">Dummy Email</label>
											<input type="text"  class="form-control"  placeholder="Enter Dummy email"  name="dummy_email"  value="{{@$template->dummy_email}}" >
										</div>
										<div class="clearfix"></div>
										<div class="form-group rm50" id="AboutMe">
											<label for="title">Dummy Mobile</label>
											<input type="text"  class="form-control"  placeholder="Enter Dummy mobile"  name="dummy_ph" value="{{@$template->dummy_ph}}">
										</div>
										
										<div class="form-group rm50" id="AboutMe">
											<label for="title">Dummy Company</label>
											<input type="text"  class="form-control"  placeholder="Enter Dummy company"  name="dummy_company"value="{{@$template->dummy_company}}" >
										</div>
										<div class="clearfix"></div>
										<div class="form-group rm50" id="AboutMe">
											<label for="title">Dummy Address</label>
											<input type="text"  class="form-control"  placeholder="Enter Dummy address"  name="dummy_address"  value="{{@$template->dummy_address}}">
										</div>
										<div class="form-group rm50" id="AboutMe">
											<label for="title">Dummy Tagline</label>
											<input type="text"  class="form-control"  placeholder="Enter Dummy tagline"  name="dummy_tag" value="{{@$template->dummy_tag}}">
										</div>
									</div>
									<div class="clearfix"></div>
									<div class="review_img rmm_001" style="display: none;margin-left: 30px;">
