    ...
    <div class="content-page">
      ...
      <div class="content">
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              <h4 class="pull-left page-title">Template Management</h4>
                        ...
                        <table class="table">
                          <thead>
                            <tr>
                              <th>#</th>
                              <th>Template name</th>
                               <th>Template Front Images</th>
                                <th>Template Back Images</th>
                              <th>Status</th>
                              {{-- <th>Meta title</th>
 --}}                             
                          ...
                          <tbody>
                            ...
                            <td>{{ $key+ $templates->firstItem() }}</td>
                              ...
                              <td>{{$value->name}}</td>
                              <td><img src="{{url('/')}}/storage/app/public/template_front/{{@$value->image}}" style="width: 150px;height: 150px"></td>
                               <td><img src="{{url('/')}}/storage/app/public/template_back/{{@$value->back_image}}" style="width: 150px;height: 150px"></td>
                              <td>
                              	@if($value->status=="A")
                              	Active
                              	@else
