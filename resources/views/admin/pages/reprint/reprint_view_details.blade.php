...
@section('title')
<title>Admin | View Card Details</title>
@endsection
@section('left_part')
...
<div class="content-page">
	...
	<div class="content">
		...
		<div class="wraper container-fluid">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Card Details Page</h4>
					<ol class="breadcrumb pull-right">
                                <li><a href="{{route('admin.dashboard.home')}}">SPADE KARD</a></li>
                                <li class="active">Card Details Page</li>
                     </ol>
				</div>
			</div>
								...
								<div class="panel panel-default panel-fill">
									...
									<div class="panel-body">
										<div class="about-info-p">
											<strong>Master Card No</strong>
											<br>
											<p class="text-muted">{{@$details->master_added_user_id}}</p>
										</div>
										<div class="about-info-p">
											<strong>Re-print Card No</strong>
											<br>
